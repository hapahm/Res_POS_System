...
export const onActiveConversations = (callback) => {
    socket?.on('active_conversations', callback);
};

export const onCustomerChatActivity = (callback) => {
    socket?.on('customer_chat_activity', callback);
};
...
export const offActiveConversations = () => {
    socket?.off('active_conversations');
};

export const offCustomerChatActivity = () => {
    socket?.off('customer_chat_activity');
};
