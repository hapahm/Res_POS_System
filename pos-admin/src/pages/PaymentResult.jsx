...
const PaymentResult = () => {
    ...
    const getStatusBadge = () => {
        switch (status) {
            case "success":
                return (
                    <div className="h-20 w-20 rounded-full bg-[#243324] border border-[#02ca3a] flex items-center justify-center">
                        <svg className="w-10 h-10 text-[#02ca3a]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            case "failed":
                return (
                    <div className="h-20 w-20 rounded-full bg-[#3b2a2a] border border-[#ff6b6b] flex items-center justify-center">
                        <svg className="w-10 h-10 text-[#ff6b6b]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            case "expired":
                return (
                    <div className="h-20 w-20 rounded-full bg-[#5a4a2f] border border-[#f6b100] flex items-center justify-center">
                        <svg className="w-10 h-10 text-[#f6b100]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    return (
        <section className="bg-[#1f1f1f] min-h-screen flex items-center justify-center px-4 py-8">
            <div className="bg-[#262626] rounded-xl border border-[#383838] p-6 md:p-8 max-w-2xl w-full text-center shadow-xl">
                ...
                <div className="flex flex-col items-center gap-5 my-6">
                    ...
                    <div className="w-full bg-[#1a1a1a] rounded-lg p-4 md:p-5 text-left border border-[#333]">
                        <div className="flex justify-between text-sm mb-2 gap-4">
                            <span className="text-[#ababab]">Mã giao dịch:</span>
                            <span className="text-[#f5f5f5] font-mono text-right break-all">
                        ...
                        {searchParams.get("vnp_Amount") && (
                            <>
                                <div className="flex justify-between text-sm mb-2 gap-4">
                                    ...
                                    <span className="text-[#f5f5f5] font-semibold text-right">
                                ...
                                <div className="flex justify-between text-sm mb-2 gap-4 pt-2 border-t border-[#333]">
                ...
                <div className="flex flex-col md:flex-row gap-3">
                    {status === "success" && (
                        <button
                            ...
                            className="flex-1 bg-[#1a1a1a] text-[#f5f5f5] rounded-lg px-6 py-3 hover:bg-[#2c2c2c] border border-[#333]"
                        >
                            In hóa đơn
                        </button>
                    )}
