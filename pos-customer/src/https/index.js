...
export const getCustomerTables = () => axiosWrapper.get("/api/customer/tables");
export const customerReserveTable = (tableId, reservationNote = "") =>
  axiosWrapper.post(`/api/customer/tables/${tableId}/book`, { reservationNote });
export const customerCheckInTable = (tableId) =>
  axiosWrapper.post(`/api/customer/tables/${tableId}/check-in`);
