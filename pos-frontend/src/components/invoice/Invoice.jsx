      ...
      <div className="bg-white p-4 rounded-lg shadow-lg w-[400px]">
        ...
        <div ref={invoiceRef} className="p-4">
          ...
          <div className="mt-4 border-t pt-4">
            <h3 className="text-sm font-semibold">Danh sách món đã gọi</h3>
          ...
          <div className="mb-2 mt-2 text-xs">
            {orderInfo.paymentMethod === "Cash" ? (
              ...
              <>
                <p>
                  <strong>Phương thức thanh toán:</strong> Thanh toán online
                </p>
                <p>
                  <strong>Mã đơn Razorpay:</strong>{" "}
                  {orderInfo.paymentData?.razorpay_order_id}
                </p>
                <p>
                  <strong>Mã giao dịch Razorpay:</strong>{" "}
