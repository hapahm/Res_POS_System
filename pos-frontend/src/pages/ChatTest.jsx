...
const ChatTest = () => {
    ...
    const [customerName] = useState(searchParams.get('name') || `Customer ${customerId.slice(0, 8)}`);
    ...
    useEffect(() => {
        ...
        const handleReceiveMessage = (data) => {
            ...
            setMessages(prev => [...prev, {
                ...
                senderName: data.senderName || 'Assistant',
        ...
        <div className="h-screen flex flex-col bg-white">
            ...
            <div className="border-t border-gray-200 bg-blue-50 p-3">
                <p className="text-xs text-blue-700">
                    🧪 <strong>Test Mode:</strong> Customer ID: <code className="bg-blue-100 px-2 py-1 rounded">{customerId}</code> |
                    Conversation: <code className="bg-blue-100 px-2 py-1 rounded ml-2">{conversationId}</code>
                </p>
            </div>
            ...
            <ChatInput
                ...
                placeholder={connected ? "Send a test message..." : "Waiting for connection..."}
            />
        </div>
    );
};
