...
const Auth = () => {
  ...
  return (
    <div className="flex min-h-screen w-full bg-[#1a1a1a]">
      ...
      <div className="w-full lg:w-1/2 min-h-screen bg-[#1a1a1a] px-6 py-8 md:px-10 md:py-10 flex items-center justify-center">
        <div className="w-full max-w-md">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            />
            {/* Đổi tên nhà hàng */}
            <h1 className="text-3xl font-semibold text-[#f5f5f5] tracking-wide">
              KChick
            </h1>
          </div>

          {/* Tiêu đề form */}
          <h2 className="text-4xl text-center mt-10 font-semibold text-yellow-400 mb-8">
            {isRegister
              ? "Đăng ký"
              : "Đăng nhập"}
          </h2>
